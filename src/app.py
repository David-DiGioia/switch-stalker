...
quinn_url_1 = 'https://www.target.com/p/ella-mila-nail-care-nail-strengthener--first-aid-kiss----0-45-fl-oz/-/A-52901450'
...
def main():
    ...
    target_nail = websites.Target(quinn_url_1)
    task3 = task.Task(target_nail)
    task3.start()
